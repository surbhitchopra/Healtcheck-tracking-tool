...
class HealthCheckSession(models.Model):
    ...
    initiated_by = models.ForeignKey(User, on_delete=models.CASCADE, related_name='hc_sessions')
    created_at = models.DateTimeField(auto_now_add=True)
...
class HealthCheckFile(models.Model):
    ...
    customer = models.ForeignKey(Customer, on_delete=models.CASCADE)
    session = models.ForeignKey(HealthCheckSession, on_delete=models.CASCADE, null=True, blank=True)
