...
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'HealthCheck_proj.settings')
django.setup()

# Now import Django models
from HealthCheck_app.models import Customer, Network

def inspect_monthly_data():
    """Direct inspection of monthly_runs data in database"""
...
def simple_monthly_conversion():
    """Simple conversion to test our logic"""
    print("\n🔧 SIMPLE CONVERSION TEST")
    print("=" * 40)
    
    # Get BSNL data specifically
    try:
...
if __name__ == "__main__":
    inspect_monthly_data()
    simple_monthly_conversion()