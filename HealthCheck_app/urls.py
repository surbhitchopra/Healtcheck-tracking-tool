...
urlpatterns = [
    ...
    path('api/excel-summary/', views.get_excel_summary_data, name='get_excel_summary_data'),
    ...
    path('api/customer-dashboard/update-network/', views.update_customer_network, name='update_customer_network'),
